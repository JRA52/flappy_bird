...
void StateMachine::change_state(const std::string& state_name, std::shared_ptr<World> world, std::shared_ptr<Bird> bird, bool hardMode) noexcept
{
    ...
    current_state->enter(world, bird, hardMode);
}
